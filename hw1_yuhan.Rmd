...
First, we take a look at the female proportion in SE/non-SE across year. The female proportSE across year")
```ion in SE is decreasing while the proportion in non-SE is increasing across year.
